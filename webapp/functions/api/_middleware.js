...
const PUBLIC_PATHS = ["/api/login", "/api/signup", "/api/logout", "/api/telegram", "/api/telegram-interview", "/api/pool", "/api/setup-webhooks", "/api/billing-webhook", "/api/contact", "/api/turnstile-key"];
